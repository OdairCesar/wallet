...
return [
    ...
    'info' => [
        ...
        'description' => <<<'MD'
API de carteira digital alinhada ao **Open Finance Brasil**.

### Headers recomendados (FAPI)
- `x-fapi-interaction-id` — UUID de correlação (gerado automaticamente se omitido)
- `x-idempotency-key` — obrigatório em operações de escrita (transferências, pagamentos)

### Base path
Todos os endpoints estão sob `/api/open-banking/`.
MD,
    ],

    'ui' => [
        'title' => 'Wallet — Open Finance API',
    ],
    ...
    'renderers' => [
        ...
        'elements' => [
            'view' => 'scramble::docs',
            'theme' => 'light',
            'hideTryIt' => env('APP_ENV') === 'production',
            'hideSchemas' => false,
            'logo' => '',
